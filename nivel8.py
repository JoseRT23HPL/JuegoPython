...
songs = [
    ...
    "3. NIVEL 1 - 'CAMINO AL DESCONOCIDO' - Composición: Compositor", 
    "4. NIVEL 2 - 'BOSQUE MÍSTICO' - Composición: Compositor",
    "5. NIVEL 3 - 'MONTAÑAS HELADAS' - Composición: Compositor",
    "6. NIVEL 4 - 'DESIERTO ARDIENTE' - Composición: Compositor",
    "7. NIVEL 5 - 'CASTILLO OSCURO' - Composición: Compositor",
    "8. BATALLA FINAL - 'DUELO ÉPICO' - Composición: Compositor",
    "9. CRÉDITOS - 'HASTA LA PRÓXIMA AVENTURA' - Composición: Compositor",
    "",
    "EFECTOS DE SONIDO",
